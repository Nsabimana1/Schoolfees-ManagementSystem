    ...
    <div class="container-fluid wholepage">
      ...
      <div class="tab-content">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card bg-info card1">
                    <h2>School Fees Payment Total Amount Per Semester</h2>
                ...
                <div class="col-md-9">
                  ...
                  <div class="card bg-info card2">
                    ...
                    <form>
                      ...
                      <form method="POST" action="backend/Model/reseting_accout.php">
                       <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                        <input id ="password" type="text" class="form-control" name="old_password" placeholder="Old Password" style="width: 40%;">
                        <input id ="password" type="text" class="form-control" name="new_password" placeholder="New Password" style="width: 40%;">
                      </div>
                      <br>
